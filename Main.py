...
def colorize(val):
    color = "#FF6347" if val == 'Negative' else "#90EE90" if val == 'Positive' else "#808080"
...
st.markdown('''
    ...
    Result: The <span style='color: #90EE90'>actor</span> is great but sadly the <span style='color: #FF6347'>camera shaking</span> is too much
        ...
        with st.spinner("Analyzing..."):
            try:
                ...
                if vader_scores:
                    ...
                    with col2:
                        st.markdown("### Vader Emotion Sentiment Result")
